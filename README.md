...
Every spec runs across ten projects: Chromium, Firefox and WebKit on desktop, plus Pixel 7,
iPhone 15 and a narrow-viewport Firefox on phones, plus four in-between touch sizes - an iPad Pro
11 in portrait, a Galaxy Tab S4 in landscape, and the Galaxy Z Fold 7's unfolded (984x1016, nearly
square) and cover (360x764) screens. Two caveats worth knowing:
